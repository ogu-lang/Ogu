...
public class TupleValDeclarationNode extends ValDeclarationNode {
    ...
    public TupleValDeclarationNode(List<IdentifierNode> ids, Map<IdentifierNode, TypeUsageWrapperNode> types, ExpressionNode value, List<DecoratorNode> decoratorNodes) {
