...
public class TupleValDeclaration extends ValDeclaration {
    ...
    public TupleValDeclaration(List<OguIdentifier> ids, Expression value, List<Decorator> decorators) {
    ...
    public TupleValDeclaration(List<OguIdentifier> ids, OguType type, Expression value, List<Decorator> decorators) {
